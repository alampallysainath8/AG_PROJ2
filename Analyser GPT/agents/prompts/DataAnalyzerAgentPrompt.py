...
```
or try to use this style 
import subprocess
import sys

# Install required libraries
subprocess.check_call([sys.executable, "-m", "pip", "install", "pandas", "matplotlib"]) in the starting of code block.
send the code again with with bash script to install dependencies an
